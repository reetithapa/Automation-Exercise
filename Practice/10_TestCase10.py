...
def subscription(driver):
    ...
    print("'SUBSCRIPTION' is visible successfully")

    driver.find_element(By.ID, "susbscribe_email").send_keys("helloww@gmail.com")
    driver.find_element(By.ID, "subscribe").click()

    success_msg = driver.find_element(By.CSS_SELECTOR, "div.alert-success.alert")
    assert success_msg.is_displayed()
    assert success_msg.text == "You have been successfully subscribed!"
